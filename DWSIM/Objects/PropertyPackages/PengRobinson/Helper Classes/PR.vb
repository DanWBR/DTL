            ...
            If forcephase <> "" Then
                If forcephase = "L" Then
                    ...
                    Catch ex As Exception
                        Throw New ArgumentException("PR fugacity calculation error: unable to find Z for liquid phase at " & T & " K and " & P & "  Pa. " & ex.Message.ToString, ex)
                    End Try
                ElseIf forcephase = "V" Then
                    Try
                        Z = Common.Max(_zarray.ToArray())
                    Catch ex As Exception
                        Throw New ArgumentException("PR fugacity calculation error: unable to find Z for vapor phase at " & T & " K and " & P & " Pa. " & ex.Message.ToString, ex)
                    End Try
                End If
            Else
        ...
        Function CalcZ(ByVal T, ByVal P, ByVal Vx, ByVal VKij, ByVal VTc, ByVal VPc, ByVal Vw) As ArrayList
            ...
            Else
                ...
                Do
                    ...
                    If ZV < 0 Then ZV = 1
                    lc += 1
                Loop Until Math.Abs(findZV) < 0.0001 Or lc > 1000
