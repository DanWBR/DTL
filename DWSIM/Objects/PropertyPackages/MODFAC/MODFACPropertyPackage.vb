...
Namespace DTL.SimulationObjects.PropertyPackages
    ...
    <Runtime.InteropServices.Guid(MODFACPropertyPackage.ClassId)>
    <Serializable()> Public Class MODFACPropertyPackage
        ...
        Private m_uni As New Auxiliary.Modfac
...
#Region "Auxiliary Functions"
        ...
        Function RET_VEKI() As Object
            ...
            Dim subst As BaseThermoClasses.Substance
            Dim VEKI(Me.CurrentMaterialStream.Phases(0).Components.Count - 1, Me.m_uni.ModfGroups.Groups.Count - 1) As Double
            Dim i As Integer = 0
            Dim sum As Double
            For Each subst In Me.CurrentMaterialStream.Phases(0).Components.Values
                sum = 0
